    ...
    <div className="relative -mx-1">
      ...
      onTouchEnd={() => setActiveIndexRetention(null)}
        ...
        <text x={getX(lastIdx) - 6} y={height - 7} textAnchor="middle" fill={editingRightX ? PINK : "#d1d5db"} fontSize="13" fontFamily="sans-serif" className={locked ? "cursor-default" : "cursor-pointer"} onClick={() => { if (locked) return; setRightXValue(dynamicDurLabel); setEditingRightX(true) }}>{dynamicDurLabel}</text>
          ...
          <line x1={getX(activeIndexRetention)} x2={getX(activeIndexRetention)} y1={padding.top} y2={height - padding.bottom} stroke="#ffffff" strokeDasharray="6 4" strokeWidth="1" pointerEvents="none" />
        )}
      ...
      >
        ...
        {mainTab === tab && (
          <motion.div
            ...
            initial={false}
            className="absolute bottom-0 left-3 right-4 h-[2px] bg-white rounded-full"
    ...
    >
     {/* Uploadable icon */}
      <div
        ...
        style={{ width: 44, height: 44, marginTop: 7 }}
      ...
      <div style={{ flex: 1, paddingRight: "20px" }}>
        <div style={{ color: "#fff", fontSize: "12px", fontWeight: 700, lineHeight: 1.0 }}>
          {"Your reel got over "}
          {editingCelebration ? (
            <input
        ...
        <div style={{ marginTop: "5px", color: "#d1d1d6", fontSize: "10px", lineHeight: 1.35 }}>
...
<section ref={overviewRef} key={animationKey} className="px-5 pt-0 pb-4">
